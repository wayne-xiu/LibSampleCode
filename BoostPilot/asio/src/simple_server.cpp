...
// a multi-threaded sever that handles incoming connections from clients, listens for incoming messages
// from the connected clients, and dispatches the messages to a pool of worker trheads for processing
class Connection : public std::enable_shared_from_this<Connection>
{
public:
    Connection(boost::asio::io_service &ios, boost::asio::ip::tcp::socket socket)
