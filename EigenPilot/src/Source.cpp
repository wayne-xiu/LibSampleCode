...
void MatrixMultiply(const double *m1, const double *m2, int m, int n, int k, double *result)
{
    int i, j, l, u;
...
int main(int argc, char* argv[])
{
	...
	cout << "matrix size: " << diagMatrix.rows() << "x" << diagMatrix.cols() << endl;
	...
	Transform t(r);
	// cout << "transformation matrix:\n" << t << endl;  // t couldn't be printed directly
	Vector3 euler_xyz = t.rotation().eulerAngles(2, 1, 0).reverse();  // didn't know reverse() can be used this way
